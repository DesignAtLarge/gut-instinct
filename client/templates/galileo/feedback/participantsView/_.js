...
Template.gaParticipantsView.onCreated(function() {
...
Template.gaParticipantsView.onRendered(function() {
...
Template.gaParticipantsView.onDestroyed(function() {
    $(".detail-feedback-checklist").off('scroll');
})

Template.gaParticipantsView.helpers({
    ...
    hasPermissionViewFeedbackFollowup: function() {
        ...
        if ((expCreatorID && expCreatorID === Meteor.userId()) || (Meteor.user().profile.is_admin)) {
            return true;
        } else {
            return false;
        }
...
Template.gaParticipantsView.events({
