...
Template.new_login.onCreated(function() {
...
//     $('#attention-getter-words').css({'font-size': '16pt'});
//     $('#click-login-btn').hide();
//     $(event.target).parent().siblings().hide();
//     $(event.target).css({'font-size': '18pt'});
//     $('.description').css({ 'width': '65%' });
//     $('.description').find('h1').css({ 'text-align': 'left' });
//
//     $('.sign_in').show();
// }
//
