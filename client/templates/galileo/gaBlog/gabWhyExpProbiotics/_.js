...
Template.gabWhyProbiotics.onCreated(function() {
    Session.setDefault('isDemo', true);

    let inst = Template.instance();
    inst.form = new ReactiveVar(undefined);

    Meteor.call('galileo.boards.getGoogleForm', "PROBIOTICS", function(err, result) {
        inst.form.set(result)
        $("title").html("Galileo | Why Exp Gut Check");
    });
});

Template.gabWhyProbiotics.helpers({
    "form": function() {
...
Template.gabWhyProbiotics.events({
