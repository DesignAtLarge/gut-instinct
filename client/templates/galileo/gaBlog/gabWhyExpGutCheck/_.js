...
Template.gabWhyExpGutCheck.onCreated(function() {
    Session.setDefault('isDemo', true);

    let inst = Template.instance();
    inst.form = new ReactiveVar(undefined);

    Meteor.call('galileo.boards.getGoogleForm', "AMERICANGUT", function(err, result) {
        inst.form.set(result)
        $("title").html("Galileo | Why Exp Gut Check");
    });
});

Template.gabWhyExpGutCheck.helpers({
    "form": function() {
...
Template.gabWhyExpGutCheck.events({
